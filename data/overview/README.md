...
The [first conversation dataset](../README.md) is committed under
...
[Version 1 contracts](../../docs/contracts.md) define one conversation format for train,
validation, and test, with versioned split manifests and offline validation commands. The [pilot release](../README.md) uses these contracts.
...
[source-statistics.json](source-statistics.json).
...
The [curation package](../source-review/README.md) contains **21 inspected passage records**:
...
The [pilot release documentation](../README.md) records the current scope,
...
public domain. See the [source policy](../source-review/source-policy.md) for header credits,
